...
| 🤖 Smart rules | AI evaluates natural language policies in real-time |
...
# With Latch
Agent: "Search for API keys in ~/"  
→ 🛑 Blocked by smart rule: "Searches targeting sensitive files"
...
<CardGroup cols={2}>
  ...
  <Card title="Smart Rules" icon="sparkles">
    Define policies in plain English. An AI evaluates each tool call against your conditions.
  </Card>
