 ...
 */
import { classifyToolCall, computeArgsHash, computeRequestHash, redactArgs, getDefaultDecision, } from "@latch/shared";
...
test("redacts long content", () => {
    ...
    assertTrue(result.redacted.description.includes("[REDACTED:600 chars]"), "Should redact long content");
});
